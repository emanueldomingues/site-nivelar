  ...
  return (
    <div className="bg-black text-white">
      ...
      <header className="fixed top-0 w-full bg-black/90 backdrop-blur z-50 border-b border-gray-800">
        <div className="flex items-center justify-center relative px-4 py-8">
          ...
          <div className="absolute left-0 flex flex-col leading-tight ml-3 mt-4">
            <h1 className="text-5xl font-black tracking-wide">NIVELAR</h1>
      ...
      <section id="home" className="h-[80vh] relative flex items-center justify-center">
        ...
        <h2 className="relative z-10 text-4xl md:text-6xl font-bold text-center">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-7xl mx-auto">
          {projetos.map((img, i) => (
            <img
              ...
              className="cursor-pointer rounded-xl object-cover h-[280px] w-full hover:scale-105 transition"
            />
          ))}
        </div>
      </section>
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-6 max-w-7xl mx-auto">
          {equipamentos.map((img, i) => (
            <img
              ...
              src={img}
              onClick={() => setModalImg(img)}
              className="cursor-pointer rounded-xl object-cover h-[160px] w-full hover:scale-105 transition"
            />
          ))}
        </div>
      </section>
      ...
      {modalImg && (
        ...
        >
          <img src={modalImg} className="max-w-[90%] max-h-[90%] rounded-lg" />
        </div>
      )}
      ...
      <a
        ...
        target="_blank"
        className="fixed bottom-6 right-6 bg-green-500 p-4 rounded-full text-white text-2xl shadow-lg hover:scale-110"
      >
        <FaWhatsapp />
      </a>
